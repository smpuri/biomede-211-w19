...
\begin{enumerate}
	\item $\rho \rightarrow$ materials ability to resist flow ($\Omega$m)
	\item $l \rightarrow$ length of the element (m)
	\item $A \rightarrow$ cross sectional area of element (m$^2$)
\end{enumerate}
